                ...
                <nav>
                    <ul class="header-nav__list">
                        <li class="header-nav__list-item">
                            <a href="#menu" class="header-nav__list-item__text">菜單</a>
                        </li>
                        <li class="header-nav__list-item">
                            <a href="#introduction" class="header-nav__list-item__text">店鋪資訊</a>
                        </li>
                        <li class="header-nav__list-item">
                            <a href="#info" class="header-nav__list-item__text">最新消息</a>
                        </li>
                        <li class="header-nav__list-item">
                            <a href="#store" class="header-nav__list-item__text">聯絡我們</a>
                        </li>
                        ...
                        <li class="reservation">
                            <a href="#" class="reservation-text reservation-ja">線上預約</a>
                        </li>
                        <li>
                            <div class="header-nav__language-button">
            ...
            <div class="header-nav__menu">
                <ul class="header-nav__menu-list">
                    <li class="header-nav__menu-item">
                        <a href="#commit" class="header-nav__menu-item__text">燒肉團的堅持</a>
                    </li>
                    <li class="header-nav__menu-item">
                        <a href="#part" class="header-nav__menu-item__text">不同部位的風味</a>
                    </li>
                    <li class="header-nav__menu-item">
                        <a href="#difference" class="header-nav__menu-item__text">和牛跟日本國產牛的不同</a>
                    </li>
                    <li class="header-nav__menu-item">
                        <a href="#menu" class="header-nav__menu-item__text">菜單</a>
                    </li>
                    <li class="header-nav__menu-item">
                        <a href="#allergy" class="header-nav__menu-item__text">食物過敏</a>
                    </li>
                    <li class="header-nav__menu-item">
                        <a href="#introduction" class="header-nav__menu-item__text">店鋪介紹</a>
                    </li>
                    <li class="header-nav__menu-item">
                        <a href="#info" class="header-nav__menu-item__text">最新消息</a>
                    </li>
                    <li class="header-nav__menu-item">
                        <a href="#thought" class="header-nav__menu-item__text">我們的理想</a>
                    </li>
                    <li class="header-nav__menu-item">
                        <a href="#access" class="header-nav__menu-item__text">交通方式</a>
                    </li>
                    <li class="header-nav__menu-item">
                        <a href="#store" class="header-nav__menu-item__text">店鋪資訊</a>
                    </li>
                </ul>
            </div>
    ...
    <main>
        ...
        <div class="wrap">
            ...
            <section id="commit" class="commit">
                <div class="inner">
                    <div class="commit-title">
                        <h1>
                            <img src="./image/chinese/commit-title_ch_sp.jpg" alt="焼肉工房「團」 こだわり">
                        </h1>
                    </div>
                    <ul class="commit-list">
                        <li class="commit-list_item">
                            <h3 class="commit-item__title">優質和牛，主要選用沖繩和牛</h3>
                            <p>店內主要選用A4等級以上的「黑毛和牛」。黑毛和牛是在完善的生產環境下成長，徹底管控生產履歷與衛生的環境。嚴選提供油花與瘦肉完美比例的肉品。</p>
                        </li>
                        <li class="commit-list_item">
                            <h3 class="commit-item__title">新鮮的日本國產蔬菜</h3>
                            <p>本店堅持使用美味、安心又安全的食材，適合包肉的生菜、用來自製泡菜的大白菜… 這些全部都是採用日本國產的新鮮蔬菜。</p>
                        </li>
                        <li class="commit-list_item">
                            <h3 class="commit-item__title">店家自製沾醬，帶出肉品的鮮味</h3>
                            <p>６種自製沾醬，根據肉的部位及吃法不同，搭配不同種類的醬汁品嘗，讓和牛本身的風味更加突出。</p>
                        </li>
                        <li class="commit-list_item">
                            <h3 class="commit-item__title">自製沖繩和牛特調湯頭</h3>
                            <p>使用了牛筋高湯、雞骨、鯖魚片高湯調製的湯頭和慢火細熬、濃縮各種精華的冷麵湯汁…這些湯頭，都加入了大量的牛筋、雞骨與香味蔬菜。</p>
                        </li>
                        <li class="commit-list_item">
                            <h3 class="commit-item__title">味道層次豐富的自製泡菜</h3>
                            <p>使用了用多種蝦子為基底製成的自製藥念醬(泡菜醃醬)調味，並嚴格控管溫度、仔細計算發酵時間以提升鮮味，才能打造出如此溫和醇厚的味道。</p>
                        </li>
                    </ul>
                </div>
            </section>
            ...
            <section id="part" class="part">
                <h2 class="section-title">不同部位的風味</h2>
                <figure class="part-img">
                    <img src="./image/chinese/part-img_ch.jpg" alt="焼肉工房「團」 牛肉 部位　部位ごとの旨み">
                </figure>
                <ul class="part-list flex_box"> 
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_1">牛里肌<span style="font-size:11px;">（肩肉）</span></a>
                        </h4>
                        <div id="part_1" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/ro-su_ch.jpg" alt="焼肉工房「團」 ロース肩肉">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_2">牛板腱</a>
                        </h4>
                        <div id="part_2" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/misuji_ch.jpg" alt="焼肉工房「團」 ミスジ">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_3">上等牛里肌</a>
                        </h4>
                        <div id="part_3" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/jouro-su_ch.jpg" alt="焼肉工房「團」 上ロース">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_4">沙朗</a>
                        </h4>
                        <div id="part_4" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese//part/sa-roin_ch.jpg" alt="焼肉工房「團」 サーロイン">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_5">特級牛里肌</a>
                        </h4>
                        <div id="part_5" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/tokujouro-su_ch.jpg" alt="焼肉工房「團」 特上ロース">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_6">牛舌</a>
                        </h4>
                        <div id="part_6" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/namitan_ch.jpg" alt="焼肉工房「團」 並タン">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_7">牛五花</a>
                        </h4>
                        <div id="part_7" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/karubi_ch.jpg" alt="焼肉工房「團」 カルビ">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_8">上等牛舌</a>
                        </h4>
                        <div id="part_8" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/joutan_ch.jpg" alt="焼肉工房「團」 上タン">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_9">上等牛五花</a>
                        </h4>
                        <div id="part_9" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/joukarubi_ch.jpg" alt="焼肉工房「團」 上カルビ">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_10">丸腸<span style="font-size:11px;">(小腸)</span></a>
                        </h4>
                        <div id="part_10" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/marutyou_ch.jpg" alt="焼肉工房「團」 丸腸(小腸)">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_11">特級牛五花</a>
                        </h4>
                        <div id="part_11" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/tokujoukarubi_ch.jpg" alt="焼肉工房「團」 特上カルビ">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_12">內臟<span style="font-size:11px;">（牛大腸）</span></a>
                        </h4>
                        <div id="part_12" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/horumon_ch.jpg" alt="焼肉工房「團」 ホルモン(大腸)">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_13">火焰牛五花</a>
                        </h4>
                        <div id="part_13" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/h-karubi_ch.jpg" alt="焼肉工房「團」 炎のカルビ">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_14">牛肝</a>
                        </h4>
                        <div id="part_14" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/reba_ch.jpg" alt="焼肉工房「團」 レバー">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_15">牛臀蓋</a>
                        </h4>
                        <div id="part_15" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/ichibo_ch.jpg" alt="焼肉工房「團」 イチボ">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_16">牛心</a>
                        </h4>
                        <div id="part_16" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/hatu_ch.jpg" alt="焼肉工房「團」 ハツ">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_17">牛頰肉</a>
                        </h4>
                        <div id="part_17" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/turami_ch.jpg" alt="焼肉工房「團」 ツラミ">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_18">重瓣胃<span style="font-size:11px;">（第三個胃）</span></a>
                        </h4>
                        <div id="part_18" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/senmai_ch.jpg" alt="焼肉工房「團」 センマイ">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_19">牛臀肉</a>
                        </h4>
                        <div id="part_19" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/ranpu_ch.jpg" alt="焼肉工房「團」 ランプ">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
                    <li class="part-list__item">
                        <h4 class="difference-title">
                            <a class="js-modal-open" href="" data-target="part_20">上等瘤胃<span style="font-size:11px;">（第一個胃）</span></a>
                        </h4>
                        <div id="part_20" class="modal js-modal">
                            <div class="modal__bg js-modal-close"></div>
                            <div class="modal__content">
                                <img src="./image/chinese/part/joumino_ch.jpg" alt="焼肉工房「團」 上ミノ(第一胃)">
                                <a class="js-modal-close" href="">關閉</a>
                            </div>
                        </div>
                    </li>
            ...
            <section id="difference" class="difference">
                ...
                <div class="difference-block">
                    ...
                    <div class="difference-img">
                        <img src="./image/chinese/difference-map_ch.jpg" alt="焼肉工房「團」 「和牛」と「国産牛」の違い">
                    </div>
                </div>
            </section>
            <!-- difference end -->
            ...
            <section id="menu" class="menu">
                ...
                <ul class="menu-list flex_box">
                    <li class="menu-list__item">
                        <a href="./menu/dinner_ch_sp.html">
                            <img src="./image/top/dinner.jpg" class="dinner" alt="焼肉工房「團」 ディナーメニュー">
                            <h5 class="menu-list__item-title">晚餐</h5>
                            <p class="menu-list__item-title__text">能品嘗到牛里肌、牛五花與牛臀蓋等和牛的稀有部位，另外還有店家嚴選食材製作的附餐精緻料理。</p>
                        </a>
                    </li>
                    <li class="menu-list__item">
                        <a href="./menu/corse_ch_sp.html">
                            <img src="./image/top/matsu_s.png" class="corse" alt="焼肉工房「團」 コース">
                            <h5 class="menu-list__item-title">宴席套餐</h5>
                            <p class="menu-list__item-title__text">套餐菜單包含高級肉品、人氣單品料理與甜點，盡享美好用餐時光。</p>
                        </a>
                    </li>
                    <li class="menu-list__item">
                        <a href="./menu/lunch_ch_sp.html">
                            <img src="./image/top/lunch.jpg" class="lunch" alt="焼肉工房「團」 ランチ">
                            <h5 class="menu-list__item-title">午餐</h5>
                            <p class="menu-list__item-title__text">提供充滿和牛高湯鮮味的牛丼等午間限定經典套餐。</p>
                        </a>
                    </li>
                </ul>
                
                <div id="allergy" class="allergy">
                    <a class="allergy-link" href="./image/chinese/top/allergy_ch.pdf" target="_blank">食物過敏▼</a>
                </div>
            </section>
            <!-- menu end -->
            ...
            <section id="introduction" class="introduction">
                <h2 class="section-title">店鋪介紹</h2>
                <div class="slider intro_slider">
                    ...
                    <p class="introduction-text">店內有適合單人或少人數用餐的桌位，亦提供最多能容納30人的挖洞暖爐座位，可以依照您的需求做安排。</p>
            ...
            <!-- <section id="info" class="info">
                <h6 class="info-title">最新消息</h6>
                <ul class="info-list">
                    <li class="info-list__item">
                        <dl>
                            <dt class="info-list__day">2019.12</dt>
                            <dd class="info-list__text">数種のエビがベースの自家製ヤンニョム（キムチの素）でしっかりと味付</dd>
                        </dl>
                    </li>
                    <li class="info-list__item">
                        <dl>
            ...
            * html .clearfix { height:1%; }
            ...
            <section id="thought" class="thought">
                <h2 class="section-title">我們的理想</h2>
                <p class="thought-text">
                    本店的創始者親川幸男，
                    希望為客人提供「家裡吃不到」、「能夠安心品嘗」的美食。
                    更重要的是，想讓客人感受到料理的「美味」，
                    因此店內食材不只堅持選用「沖繩和牛」，對於燒肉的沾醬與蔬菜也非常講究。
                    我們承接上一代的理念，
                    希望在任何時代，大家都能圍繞在桌邊，
                    一邊享用美味燒肉，一邊歡樂談笑。
                    就如同擁有【沉穩、團聚】之意涵的店名「團」一樣。
                    我們今後也會持續精進，努力打造出這樣一家燒肉店。
                </p>
            ...
            <section id="store" class="store">
                <h2  class="section-title">店鋪資訊</h2>
                <div class="store-inner">
                    <div class="store-details">
                        <dl class="store-details__item">
                            <dt class="store-details__item-title style-effect">地址</dt>
                        ...
                        <dl class="store-details__item">
                            <dt class="store-details__item-title style-effect_3">交通方式</dt>
                            <dd class="store-details__item-text style-effect_5">
                                <span class="style-effect_4">那霸機場 乘車8分</span>
                                <br>
                                沖繩都市單軌電車 奧武山公園站<br> 徒步13分鐘
                            </dd>
                        </dl>
                        <dl class="store-details__item">
                            <dt class="store-details__item-title style-effect_2">停車場</dt>
                            <dd class="store-details__item-text style-effect_2">11輛</dd>
                        </dl>
                        <dl class="store-details__item">
                            <dt class="store-details__item-title style-effect_2">TEL</dt>
                            <dd class="store-details__item-text">
                                <a href="tel:05034764726" class="tel">050-3476-4726</a>
                            </dd>
                        </dl>
                        <dl class="store-details__item">
                            <dt class="store-details__item-title style-effect">營業時間</dt>
                            <dd class="store-details__item-text">
                        ...
                        <dl class="store-details__item">
                            <dt class="store-details__item-title style-effect_2">座位數</dt>
                            <dd class="store-details__item-text style-effect_2">60席</dd>
                        </dl>
                        <dl class="store-details__item">
                            <dt class="store-details__item-title style-effect_2">公休日</dt>
                            <dd class="store-details__item-text style-effect_2">週二</dd>
                        </dl>
                    </div>
                    <!-- <div class="store-img">
                ...
                <div class="contact">
                    <a class="contact-btn" href="#">聯絡我們</a>
                </div>
            </section>
            <!-- store -->
        </div>
