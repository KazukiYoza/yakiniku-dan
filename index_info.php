        ...
        <div class="wrap">
            ...
            <section id="commit" class="commit">
                <div class="inner">
                    <div class="commit-title">
                        <h1>
                            <img src="./image/top/commit-title.jpg" alt="焼肉工房「團」 こだわり">
                        </h1>
                    </div>
            ...
            <section id="menu" class="menu">
                ...
                <div id="allergy" class="content">
                    <a class="js-modal-open" href="">アレルギーについて▼</a>
                </div>
                <div class="modal js-modal">
                    <div class="modal__bg js-modal-close"></div>
                    <div class="modal__content">
                        <img src="./image/top/part-img.jpg" alt="">
            ...
            <section id="introduction" class="introduction">
                ...
                <div class="introduction-details">
                    <div id="slider_main">
                        <ul>
                            <li><img src="./image/introduction/introduction_1.jpg" width="400" height="300" alt="" /></li>
                            <li><img src="./image/introduction/introduction_2.jpg" width="400" height="300" alt="" /></li>
                            <li><img src="./image/introduction/introduction_3.jpg" width="400" height="300" alt="" /></li>
                            <li><img src="./image/introduction/introduction_4.jpg" width="400" height="300" alt="" /></li>
                            <li><img src="./image/introduction/introduction_5.jpg" width="400" height="300" alt="" /></li>                            
                        </ul>
                    </div><!--/#slide_main-->
                        
                    <div id="slider_thumb">
                        <ul>
                            <li><img src="./image/introduction/introduction_1.jpg" width="50" height="50" alt="" /></li>
                            <li><img src="./image/introduction/introduction_2.jpg" width="50" height="50" alt="" /></li>
                            <li><img src="./image/introduction/introduction_3.jpg" width="50" height="50" alt="" /></li>
                            <li><img src="./image/introduction/introduction_4.jpg" width="50" height="50" alt="" /></li>
                            <li><img src="./image/introduction/introduction_5.jpg" width="50" height="50" alt="" /></li>
                        </ul>
            ...
            <section id="store" class="store">
                ...
                <div class="store-inner">
                    <div class="store-details">
                        ...
                        <dl class="store-details__item">
                            <dt class="store-details__item-title">駐車場</dt>
                            <dd class="store-details__item-text">11台</dd>
                        </dl>
                        <dl class="store-details__item">
                        ...
                        <dl class="store-details__item">
                            <dt class="store-details__item-title">席数</dt>
                            <dd class="store-details__item-text">60席</dd>
                        </dl>
                        <dl class="store-details__item">
                            <dt class="store-details__item-title">定休日</dt>
                            <dd class="store-details__item-text">火曜日</dd>
                        </dl>
                    </div>
                    <div class="store-img">
