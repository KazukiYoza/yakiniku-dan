...
<body>
        ...
        <div class="wrap">
            ...
            <section id="menu" class="menu">
                ...
                <div id="allergy" class="content">
                    <a class="js-modal-open" href="./image/top/allergy.pdf">アレルギーについて▼</a>
                </div>
                ...
                <div class="introduction-details">
                    <div id="slider_main">
                        <ul><!-- width: 400px height: 300px-->
                            <li><img src="./image/introduction/introduction_1.jpg" alt="" /></li>
                            <li><img src="./image/introduction/introduction_2.jpg" alt="" /></li>
                            <li><img src="./image/introduction/introduction_3.jpg" alt="" /></li>
                            <li><img src="./image/introduction/introduction_4.jpg" alt="" /></li>
                            <li><img src="./image/introduction/introduction_5.jpg" alt="" /></li>
                        </ul>
                    </div><!--/#slide_main-->
    ...
    <footer>
        <ul>
            <li><a href="#menu" class="reservation-text">メニュー</a></li>
            <li><a href="#introduction" class="reservation-text">店舗情報</a></li>
            <li><a href="#info" class="reservation-text">お知らせ</a></li>
            <li><a href="#store" class="reservation-text">お問合せ</a></li>
            <li><a href="#" class="reservation-text">オンライン予約</a></li>
            <li><a href="sitemap/sitemap.html" class="reservation-text">サイトマップ</a></li>
        </ul>
        <p>Copyright(c)</p>
    </footer>
    <!-- footer end -->
