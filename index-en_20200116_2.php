        ...
        <div class="wrap">
            ...
            <section id="menu" class="menu">
                ...
                <div id="allergy" class="content">
                    <a class="js-modal-open" href="./image/top/allergy.pdf">About allergy▼</a>
                </div>
            ...
            <section id="introduction" class="introduction">
                ...
                <div class="introduction-details">
                    <div id="slider_main">
                        <ul>
                            <li><img src="./image/introduction/introduction_1.jpg" width="400" height="300" alt="yakiniku studio[dan] Interior" /></li>
                            <li><img src="./image/introduction/introduction_2.jpg" width="400" height="300" alt="yakiniku studio[dan] Interior" /></li>
                            <li><img src="./image/introduction/introduction_3.jpg" width="400" height="300" alt="yakiniku studio[dan] Interior" /></li>
                            <li><img src="./image/introduction/introduction_4.jpg" width="400" height="300" alt="yakiniku studio[dan] Interior" /></li>
                            <li><img src="./image/introduction/introduction_5.jpg" width="400" height="300" alt="yakiniku studio[dan] Interior" /></li>                            
                        </ul>
                    </div><!--/#slide_main-->
                        
                    <div id="slider_thumb">
                        <ul>
                            <li><img src="./image/introduction/introduction_1.jpg" width="50" height="50" alt="yakiniku studio[dan] Interior" /></li>
                            <li><img src="./image/introduction/introduction_2.jpg" width="50" height="50" alt="yakiniku studio[dan] Interior" /></li>
                            <li><img src="./image/introduction/introduction_3.jpg" width="50" height="50" alt="yakiniku studio[dan] Interior" /></li>
                            <li><img src="./image/introduction/introduction_4.jpg" width="50" height="50" alt="yakiniku studio[dan] Interior" /></li>
                            <li><img src="./image/introduction/introduction_5.jpg" width="50" height="50" alt="yakiniku studio[dan] Interior" /></li>
                        </ul>
